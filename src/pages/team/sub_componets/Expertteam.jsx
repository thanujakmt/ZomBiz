...
function ExpertTeam() {
    return (
        <>
            <div className="h-[800px] w-full my-10 flex items-center justify-center">
                <div className="container border-  2xl:px-32">
                    <div className="text text-light_gary text-center flex flex-col pl-[20px] mb-10 justify-left items-left gap-5 md:my-5 md:mb-20">
            ...
            <div className="h-[300px] w-full my-10 mb-20 flex items-center justify-center">
                <div className="container border-  2xl:px-32">
                    <div className="images_box ">
                        <div className="experts ">
                            <Swiper
